...
})}),b.menus=c}),b.getClass=function(a){return a.url===currentUrl?"menu-active":void 0},$(c).on("click",".menu-t",function(){$(this).siblings(".menu-c").slideToggle(),$(this).parent().siblings().find(".menu-c:visible").slideToggle()}).on("click",".menu-c a",function(){currentUrl=$(this).attr("href")})}var d=b.host(),e=b.absUrl(),f=new RegExp(".*"+d);return currentUrl=e.replace(f,""),{link:c}});